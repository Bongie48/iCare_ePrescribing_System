...
namespace iCare_ePrescribing_System.Migrations
{
    ...
    [Migration("20241020113703_AddNulableRemainigQuantityFieldtoTrackRemainingMeds")]
    partial class AddNulableRemainigQuantityFieldtoTrackRemainingMeds
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iCare_ePrescribing_System.Models.PrescribedMedication", b =>
                {
                    b.Property<int>("PrescribedMedicationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PrescribedMedicationId"), 1L, 1);
                    ...
                    b.Property<DateTime>("TimeAdministered")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("PrescribedMedication", "Identity");
                });
            ...
            modelBuilder.Entity("iCare_ePrescribing_System.Models.PrescriptionItem", b =>
                {
                    ...
                    b.Property<int?>("RemaininingQuantity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("iCare_ePrescribing_System.Models.PrescribedMedication", b =>
                {
                    b.HasOne("iCare_ePrescribing_System.Models.RegisteredStaff", "Nurse")
                        .WithMany()
                    ...
                    b.HasOne("iCare_ePrescribing_System.Models.PrescriptionItem", "PrescriptionItem")
                        .WithMany()
